...
sudo wget https://steamdeck-packages.steamos.cloud/archlinux-mirror/jupiter-3.7/os/x86_64/linux-neptune-611-headers-6.11.11.valve10-1-x86_64.pkg.tar.zst
...
cd ..
mkdir binder/6.11.11-valve10-1-neptune-611
#offer the kernel-module to the sd-waydroid-installer (one has always to adapt the script to include 3.8 latest)
sudo cp /usr/lib/modules/6.11.11-valve10-1-neptune-611-gb69e902b4338/updates/dkms/binder_linux.ko.zst binder/6.11.11-valve10-1-neptune-611
