...
DNS="$(cat /etc/resolv.conf|grep -im 1 '^nameserver' |cut -d ' ' -f2)"
...
#LXC_ADDR="192.168.178.1"
#LXC_NETMASK="255.255.255.0"
#LXC_NETWORK="192.168.178.0/24"
#LXC_DHCP_RANGE="192.168.178.2,192.168.178.254"
LXC_ADDR="192.168.241.1"
LXC_NETMASK="255.255.255.0"
LXC_NETWORK="192.168.241.0/24"
LXC_DHCP_RANGE="192.168.241.1,192.168.241.254"
LXC_DHCP_MAX="253"
LXC_DHCP_CONFILE=""
LXC_DHCP_PING="true"
LXC_DOMAIN=""
...
start() {
    ...
    dnsmasq -p 0 --dhcp-option=6,$DNS $LXC_DHCP_CONFILE_ARG $LXC_DOMAIN_ARG $LXC_DHCP_PING_ARG -u ${DNSMASQ_USER} \
