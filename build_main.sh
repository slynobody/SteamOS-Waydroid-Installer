...
sudo wget https://steamdeck-packages.steamos.cloud/archlinux-mirror/jupiter-main/os/x86_64/linux-neptune-611-headers-6.11.11.valve19-1-x86_64.pkg.tar.zst
...
sudo cp /usr/lib/modules/6.11.11-valve19-1-neptune-611-g88b36d49a5e3/updates/dkms/binder_linux.ko.zst binder/6.11.11-valve19-1-neptune-611 &> /dev/null
