...
sudo wget https://steamdeck-packages.steamos.cloud/archlinux-mirror/jupiter-3.7/os/x86_64/linux-neptune-611-headers-6.11.11.valve19-1-x86_64.pkg.tar.zst
sudo pacman -U ./linux-neptune-611-headers-6.11.11.valve19-1-x86_64.pkg.tar.zst --noconfirm --overwrite "*"
...
cd ..
mkdir binder/6.11.11-valve19-1-neptune-611 &> /dev/null
#offer the kernel-module to the sd-waydroid-installer (or manually adapt to include 3.7 latest)
sudo cp /usr/lib/modules/6.11.11-valve19-1-neptune-611-gg88b36d49a5e3/updates/dkms/binder_linux.ko.zst binder/6.11.11-valve19-1-neptune-611 &> /dev/null
