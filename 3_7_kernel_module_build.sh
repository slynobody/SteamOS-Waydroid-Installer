...
sudo yes '' | pacman -Syu
sudo yes '' | pacman-key --populate holo
...
cd ..
mkdir binder/6.5.0-valve19-1-neptune-65-gcd4898a4f8e6 
#offer the kernel-module to the sd-waydroid-installer (one has to adapt the script to include 3.7 latest: 65-gd5e176bdacb0)
sudo cp /usr/lib/modules/6.5.0-valve19-1-neptune-65-gcd4898a4f8e6/updates/dkms/binder_linux.ko.zst binder/6.5.0-valve19-1-neptune-65-gcd4898a4f8e6 
