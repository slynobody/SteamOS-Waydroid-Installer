...
sudo wget https://steamdeck-packages.steamos.cloud/archlinux-mirror/jupiter-main/os/x86_64/linux-neptune-68-headers-6.8.12.valve11-1-x86_64.pkg.tar.zst
sudo pacman -U ./linux-neptune-68-headers-6.8.12.valve11-1-x86_64.pkg.tar.zst
...
cd ..
mkdir binder/6.8.12-valve11-1-neptune-68
#offer the kernel-module to the sd-waydroid-installer (one has always to adapt the script to include 3.7 latest)
sudo cp /usr/lib/modules/6.8.12-valve11-1-neptune-68-g67d4ddfa283a/updates/dkms/binder_linux.ko.zst binder/6.8.12-valve11-1-neptune-68
