...
yes '' | sudo pacman -U ./linux-neptune-65-headers-6.5.0.valve19-1-x86_64.pkg.tar.zst
...
sudo cp /usr/lib/modules/6.5.0-valve19-1-neptune-65-gcd4898a4f8e6/updates/dkms/binder_linux.ko.zst binder/6.5.0-valve19-1-neptune-65
